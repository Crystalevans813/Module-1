...
average = total_amount / number_of_loans
print(f"The average loan price is $ {average:.2f}" )
...
remaining_months = loan.get("remaining_months",10)
...
print(f"The Future Value of the home is, {future_value}" )
print(f"The Annual Discount Rate is, {0.20}")
print(f"Months until sold,{remaining_months}")
...
def calculate_present_value(future_value,holding_months, annual_discount_rate):
    present_value = future_value / (1 + (annual_discount_rate / 12)) ** holding_months
